...
namespace Silent
{
    ...
    //{
    //    if (debugMsgEnabled) std::cout << msg << "\n";
    //}
    ...
    //    if (CompileProgram(ast)) DebugMsg("Compilation successful");
    //    else DebugMsg("Compilation failed");
    ...
    //    runtimeInfo.program = program;

    //    for (Subroutine* f : program->functions)
    //        CompileSubroutine(f);
    ...
    //    Namespace* oldNamespace = runtimeInfo.currentNamespace;
    //    runtimeInfo.currentNamespace = scope;
    //    ScopeInfo oldInfo = scopeInfo;
    //    scopeInfo = ScopeInfo();
    //    scopeInfo.symTable = scope->symTable;
    //    AddLabel(scope->id);

    //    for (Subroutine* f : scope->functions)
    //        CompileSubroutine(f);

    //    DebugMsg("\033[32mFinished compiling namespace: " + 
    //        scope->id + "\033[0m");
    //    scopeInfo = oldInfo;
    //    runtimeInfo.currentNamespace = oldNamespace;
    //    return true;
    //}

    //bool CodeGenerator::CompileSubroutine(Subroutine* function)
    //{
    //    // Enter a subroutine and insert a label
    //    DebugMsg("\033[36mCompiling subroutine: " + function->id + "\033[0m");
    //    ScopeInfo oldInfo = scopeInfo;
    //    scopeInfo = ScopeInfo();
    ...
    //    {
    //        Variable* v = new Variable(param);
    //        v->scopeIndex = scopeInfo.stackPtr;
    //        scopeInfo.stackPtr += GetType(v->type)->GetSize();
    //    }

    //    for (LocalStatement ls : function->statements)
    //        CompileLocalStatement(ls);

    //    DebugMsg("\033[32mFinished compiling subroutine: " + 
    //        function->id + "\033[0m");
    //    scopeInfo = oldInfo;
    //    return true;
    //}

    //bool CodeGenerator::CompileLocalStatement(LocalStatement ls)
    //{
    //    DebugMsg("Compiling a local statement");
    //    switch (ls.type)
    //    {
    //        case LocalStatement::Type::Expression: 
    //            CompileExpression(ls.expression);
    //        break;

    //        case LocalStatement::Type::VariableDeclaration: 
    ...
    //bool CodeGenerator::CompileVariableDecleration(Variable* varDec)
    //{
    ...
    //        {
    //            DebugMsg("Subtraction");
    //        }
    //        break;

    //        case Operand::Type::Mul:
    //        {
    //            DebugMsg("Multiplication");
    //        }
    //        break;
    ...
    //        {
    //            Subroutine* func = (Subroutine*)symTable->self.GetNode();
    //            return func->id;
    //        }
    //        break;
    //    }
