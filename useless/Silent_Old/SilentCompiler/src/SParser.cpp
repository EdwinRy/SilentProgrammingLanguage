...
namespace Parser
{
    ...
    void SymbolTable::AddItem(void* item, TableNode::Type type)
    {
         items.push_back(TableNode(item,type));
    }
    ...
    SymbolTable* SymbolTable::EnterScope(void* scope, TableNode::Type type)
    {
        SymbolTable* symTable = new SymbolTable();
        symTable->self = TableNode(scope, type);
    ...
    {
        SymbolTable::currentTable = SymbolTable::currentTable->GetParent();
    }
    ...
    bool Namespace::ParseScope(Parser &parser)
    {
        ...
        SymbolTable::EnterScope(this, TableNode::Type::Namespace);
    ...
    {
        parser.DebugMsg("\033[36mParsing parameters\033[0m");
        ...
        symTable = SymbolTable::EnterScope(this, TableNode::Type::Parameters);
    ...
    {
        symTable = SymbolTable::EnterScope(this, TableNode::Type::Subroutine);

        // Get function parameters
        Parameters* params = new Parameters();
        if (!params->Parse(parser))
            delete params;
